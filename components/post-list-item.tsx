...
export function PostListItem({ post }: Props) {
  ...
  return (
    <div className="timeline-entry group relative pl-6" role="listitem">
      <span className="pointer-events-none absolute left-3 top-6 z-10 flex h-3 w-3 -translate-x-1/2 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 via-sky-400 to-indigo-400 shadow-[0_0_10px_rgba(59,130,246,0.6)] transition-transform duration-300 ease-out group-hover:scale-125" aria-hidden="true" />
